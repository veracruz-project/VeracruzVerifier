...
require (
	...
	github.com/veraison/services v0.0.0-20220803104745-e3a54f7e7dfe
)
...
require (
	...
	github.com/veracruz-project/go-nitro-enclave-attestation-document v0.0.0-20220902142425-b49cd6e96cf5 // indirect
