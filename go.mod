module github.com/veracruz-project/proxy_attestation_server

go 1.18

replace github.com/veraison/services => github.com/dreemkiller/services v0.0.0-20230309234112-e845b0d11d65
