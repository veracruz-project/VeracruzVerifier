...
/home/ec2-user/go/bin/cocli comid create --template MyComidPsaIak.json
/home/ec2-user/go/bin/cocli comid create --template AWSNitroComid.json
/home/ec2-user/go/bin/cocli corim create -m MyComidPsaIak.cbor -t corimMini.json -o psa_corim.cbor
...
#curl -X POST -H 'Content-Type: application/corim-unsigned+cbor; profile=http://arm.com/psa/iot/1' --data-binary "@psa_corim.cbor" localhost:8888/endorsement-provisioning/v1/submit
/home/ec2-user/go/bin/cocli corim create -m AWSNitroComid.cbor -t corimMini.json -o nitro_corim.cbor
